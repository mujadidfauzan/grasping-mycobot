...
class GraspingEnvV1(MujocoEnv, utils.EzPickle):
    ...
    def _get_active_obj_task_pos(self):
        site_name = self._get_active_obj_info()["site_name"]
    ...
    def step(self, action):
        ...
        #     f"Objek Pos: {[f'{p:.2f}' for p in obj_pos]}, "
        #     f"Target Pos: {[f'{p:.2f}' for p in target_pos]}, "
    ...
    def _get_obs(self):
        ...
        # Object
        obj_pos = self._get_active_obj_task_pos()
        obj_quat = qpos[active_qposadr + 3 : active_qposadr + 7]
